...
if(isset($_POST['insert_product'])){
    ...
    $product_price==' ' or $product_image1==' ' or $product_image2==' ' or $product_image3==' '){
        ...
        // insert query
        $insert_products="insert into `product` (product_title,product_description,product_keywords,category_id,brand_id,
        ...
        if($result_query){
            echo "<script>lert('product inserted sucessfully')</script>";
        }
    }
}
?>
        ...
        <h1 class="text-center">Insert products </h1>
          ...
          <form action="" method="post" enctype="multipart/form-data">
            <div class="form-outline mb-4">
                ...
                id="product_title" class="form-control" placeholder="Enter a product_title" autocomplete="off" required="required">
            </div>
            <!-- description -->
            <div class="form-outline mb-4">
                <label for="description" class="form-label">Description</label>
                <input type="text" name="description"
                id="description" class="form-control" placeholder="Enter a description " autocomplete="off" required="required">
            </div>
            <!-- product_keyword -->
            <div class="form-outline mb-4">
                <label for="product_keywords" class="form-label">product_keyword</label>
                <input type="text" name="product_keywords"id="product_keywords" class="form-control" placeholder="Enter a product_keyword " autocomplete="off" required="required">
            </div>
            <!-- categories -->
            <div class="form-outline mb-4">
...
?>
        ...
        <div class="form-outline mb-4">
            ...
            <div class="form-outline mb-4">
                ...
                id="product_price" class="form-control" placeholder="Enter a product_price " autocomplete="off" required="required">
            </div>
               <!-- product button -->
               <div class="form-outline mb-4">
